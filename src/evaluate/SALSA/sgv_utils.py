...
#     sorted_vals, sorted_ids = torch.sort(min_vals, dim=1)
#     sorted_ids = sorted_ids[:,:2000]
#     # print(sorted_ids.shape)
#     # print(sorted_ids)
#     # print(min_ids.shape)
#     # print(min_vals[:,sorted_ids[0]])
#     # print(min_ids[:,sorted_ids[0]])

#     tgt_ids = min_ids[:,sorted_ids[0]].unsqueeze(-1).expand(-1, -1, 3)
#     src_ids = sorted_ids.unsqueeze(-1).expand(-1, -1, 3)

#     tgt_keypts_corr = torch.gather(tgt_keypts, 1, tgt_ids)
#     # print(tgt_keypts_corr.shape)
#     src_keypts_corr = torch.gather(src_keypts, 1, src_ids)
#     # print(src_keypts_corr.shape)
