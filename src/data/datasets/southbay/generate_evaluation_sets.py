...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str, required=False, default='/data/raktim/Datasets/Apollo-Southbay')
    ...
    pickle_name = f'test_{area}_{args.min_displacement}_{args.dist_threshold}_20m.pickle'
