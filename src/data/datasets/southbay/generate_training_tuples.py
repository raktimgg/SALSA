...
def generate_triplets(ds: SouthBayDataset, map_split: str, query_split: str,
    ...
    for triplet in triplets:
        ...
        tuple = TrainingTuple(id=new_anchor_ndx, timestamp=pc.timestamp,
                              rel_scan_filepath= ds.dataset_root + '/' +pc.rel_scan_filepath,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str, default='/data/raktim/Datasets/Apollo-Southbay', help='Path to Apollo SouthBay root folder')
