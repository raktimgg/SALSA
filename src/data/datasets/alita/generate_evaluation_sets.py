...
def get_scans(base_dir, area, split, min_displacement: float = 0.0) -> List[EvaluationTuple]:
    ...
    for ndx in range(len(pcd_files)):
        ...
        rel_scan_filepath = pcd_files[ndx][len(base_dir)+1:]
        print(rel_scan_filepath)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str, required=False, default='/data/raktim/Datasets/ALITA/VAL')
